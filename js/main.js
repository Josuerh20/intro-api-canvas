...
function draw_path() {
  ...
  function draw_bezierCuadraticas() {
    const canvas = document.getElementById("canvas_bezierCuadraticas");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  function draw_bezierCubicas() {
    const canvas = document.getElementById("canvas_bezierCubicas");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  function draw_rectangulos() {
    const canvas = document.getElementById("canvas_rectangulos");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
